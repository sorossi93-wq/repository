...
export const giftSections: GiftSection[] = [
  {
    ...
    gifts: [
      ...
      },
      {
        ...
        name: "Private Full-Day Island Escape",
        description:
          "A whole day that's just ours — a private bangka, lunch on a sandbar, and as much swimming as we can fit in before the sun goes. The one honeymoon day we would never organise for ourselves, and the one we'll talk about for years.",
        price: 500,
        image: "https://images.unsplash.com/photo-1559128010-7c1ad6e1b6a5?w=800&q=80",
      },
      {
        id: "full-day-spa",
        name: "Full-Day Luxury Spa",
        description:
          "Not a quick massage and out — a whole day of it. Treatments, lunch in robes, nowhere to be except horizontal. Sofia has been campaigning for this for months; Campbell will discover he also needed it. The couples' spa is the starter. This is the main event.",
        price: 500,
        image: "https://images.unsplash.com/photo-1540555700478-4be289f836c7?w=800&q=80",
      },
      {
