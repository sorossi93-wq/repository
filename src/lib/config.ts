...
export function getPayPalUsername(): string {
  return process.env.PAYPAL_USERNAME || "sofiaandcampbell";
}

export function getPayPalEmail(): string {
  return process.env.PAYPAL_EMAIL || "sorossi93@gmail.com";
}
...
export function getRevolutUsername(): string {
  return process.env.REVOLUT_USERNAME || "sofavq1yt";
}
